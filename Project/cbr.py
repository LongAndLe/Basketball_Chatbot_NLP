...
def find_most_similar_case(question, database):
    ...
    if highest_similarity > 0.8:  # Nếu độ tương đồng lớn hơn 0.8 thì trả về câu trả lời
...
def add_content(new_pattern,new_response):
    ...
    new_content['intents'].append(new_intent)  # Thêm   Case thông tin khách nhập vào mảng chứa thông tin
...
while True:
    ...
    print('Chatbot: '+ random.choice(wait_list)) # In ra một câu trong mảng wait_list để cho người dùng biết rằng hệ thống đang xử lý
